...
class CommentableMixin(models.Model):
    ...
    commenting_status = models.CharField(
        max_length=15,
        choices=CommentStatus.Choices,
        default=CommentStatus.INHERITED,
    )
    ...
    def should_show_new_comment_box(self):
        ...
        if commenting_ends_at:
            commenting_still_valid = (
                commenting_still_valid and commenting_ends_at > timezone.now()
            )
