...
register_image_format(Format('fullwidth', _('Full width'), 'richtext-image full-width', 'width-700'))
register_image_format(Format('left', _('Left-aligned'), 'richtext-image left', 'width-700'))
register_image_format(Format('right', _('Right-aligned'), 'richtext-image right', 'width-700'))
