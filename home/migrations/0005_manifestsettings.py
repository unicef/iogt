# Generated by Django 3.1.13 on 2021-07-13 11:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scope', models.CharField(help_text='Provide scope', max_length=255, verbose_name='Scope')),
                ('start_url', models.CharField(help_text='Provide start URL', max_length=255, verbose_name='Start URL')),
                ('display', models.CharField(choices=[('FULLSCREEN', 'fullscreen'), ('STANDALONE', 'standalone'), ('MINIMAL_UI', 'minimal-ui'), ('BROWSER', 'browser')], help_text='Provide browser UI', max_length=255, verbose_name='Browser UI')),
                ...
                ('icon_196_196', models.ForeignKey(help_text='Add PNG icon 196x196 px (maskable image can be created using https://maskable.app/)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image', validators=[home.models.ImageValidator(height=196, width=196)], verbose_name='Icon 196x196 (maskable)')),
                ('icon_512_512', models.ForeignKey(help_text='Add PNG icon 512x512 px', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image', validators=[home.models.ImageValidator(height=512, width=512)], verbose_name='Icon 512x512')),
                ('icon_96_96', models.ForeignKey(help_text='Add PNG icon 96x96 px', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailimages.image', validators=[home.models.ImageValidator(height=96, width=96)], verbose_name='Icon 96x96')),
            ],
            options={
