...
def render_article_card(context, page, title, is_first_content=False, display_section_title=False, background_color=None, font_color=None):
    theme_settings = globals_.theme_settings
...
def render_questionnaire_card(context, page, title, background_color=None, font_color=None):
    theme_settings = globals_.theme_settings
