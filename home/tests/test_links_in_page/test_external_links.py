...
class TransitionArticleForExternalLinksTests(TestCase):
    ...
    def test_if_rich_text_field_external_links_redirect_to_transition_page(self):
        body = [
            ("paragraph",
             RichText('<p><a href="https://aynthing.com">external link at the beginning</a> dolor sit amet</p>')),
            ("paragraph",
             RichText('<p>Lorem ipsum <a href="https://aynthing.com">external link in middle</a> dolor sit amet</p>')),
            ("paragraph",
             RichText('<p>Lorem dolor sit amet <a href="https://aynthing.com">external link at the end</a></p>')),
        ]
    ...
    def test_if_rich_text_field_internal_links_redirect_directly(self):
        body = [
            ("paragraph",
             RichText('<p><a id="3" linktype="page">internal link at the beginning</a> dolor sit amet</p>')),
            ("paragraph",
             RichText('<p>Lorem ipsum <a id="3" linktype="page">internal link in middle</a> dolor sit amet</p>')),
            ("paragraph",
             RichText('<p>Lorem dolor sit amet <a id="3" linktype="page">external link at the end</a></p>')),
        ]
