...
class ShortCodeService:
    ...
    def apply_shortcode(self, content):
        ...
        shortcode_service.add_shortcode(
            "insert_trick_button", self.trick_button_callback
        )
    ...
    def button_callback(self, attrs, content):
        ...
        return f'<button type="{button_type}" class="interactive-btn" name="text" value="{message}">{content}</button>'
