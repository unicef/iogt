...
class AccountSignupForm(SignupForm):
    display_name = forms.CharField(
        ...
        widget=forms.TextInput(
            attrs={
                "placeholder": _("Choose a display name that will be shown publicly if you post to the IoGT site, for example next to comments you post"),
                "class": "signup-input",
            }
        ),
        required=False,
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["password1"] = IogtPasswordField(label=_("Choose a 4-digit PIN or a longer password that you will use to login to IoGT"), autocomplete="new-password", css_class="signup-input")

        if 'password2' in self.fields:
            self.fields["password2"] = IogtPasswordField(label=_("Repeat your 4-digital PIN or longer password"), autocomplete="new-password", css_class="signup-input")
