...
def get_answer_options(field, field_option, fields_info):
    ...
    is_display_feedback = field.form.page.display_feedback
    rv = ''
    ...
    elif is_display_feedback and not is_selected and label in correct_answers:
        rv = {
            'class': 'clear-tick',
            'aria_label': 'Checkbox with tick, indicating correct but not selected',
        }
    elif is_display_feedback and not is_selected and label not in correct_answers:
        rv = {
            'class': 'clear-cross',
