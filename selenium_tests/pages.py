...
class CommentsSectionElement(BaseElement): 
    ...
    def submit_comment(self, text):
        ...
        self.leave_comment_button = self.driver.find_element(*self.leave_comment_locator)
    ...
    def delete_last_comment(self):
        self.delete_comment_button = self.driver.find_element(*self.delete_comment_locator)
        self.driver.execute_script("arguments[0].click();", self.delete_comment_button)

    def reply_last_comment(self, reply):
        self.reply_comment_button = self.driver.find_element(*self.reply_comment_locator)
    ...
    def report_last_comment(self):
        self.report_comment_button = self.driver.find_element(*self.report_comment_locator)
        self.driver.execute_script("arguments[0].click();", self.report_comment_button)
